...
public class ResearchPaper {
    ...
    private List<String> verifiedBy; // List of admin IDs who verified/approved this thesis
    private String validationDocumentPath; // Path to university/government signed validation document
    private String blockchainTxId; // Blockchain transaction ID
    private String blockchainHash; // Blockchain verification hash
    private LocalDateTime verificationDate;
    private Boolean viewable = true; // Whether this paper is publicly viewable (default: true)
    ...
    public ResearchPaper(String id, String title, String author, String department, String institution,
                        ...
                        String uploadedBy, List<String> verifiedBy, String validationDocumentPath, String blockchainTxId, String blockchainHash,
                        LocalDateTime verificationDate, Boolean viewable, List<Double> documentEmbedding, List<Double> titleEmbedding,
        ...
        this.validationDocumentPath = validationDocumentPath;
    ...
    public Boolean getViewable() { return viewable; }
    ...
    public static class ResearchPaperBuilder {
        ...
        private String validationDocumentPath;
        ...
        public ResearchPaperBuilder verifiedBy(List<String> verifiedBy) { this.verifiedBy = verifiedBy; return this; }
        public ResearchPaperBuilder validationDocumentPath(String validationDocumentPath) { this.validationDocumentPath = validationDocumentPath; return this; }
        ...
        public ResearchPaperBuilder viewable(Boolean viewable) { this.viewable = viewable; return this; }
        ...
        public ResearchPaper build() {
            return new ResearchPaper(id, title, author, department, institution, instituteId, supervisor, coSupervisor,
                                   ...
                                   abstractText, keywords, status, uploadedBy, verifiedBy, validationDocumentPath, blockchainTxId, blockchainHash,
                                   verificationDate, viewable, documentEmbedding, titleEmbedding, embeddingModel, 
